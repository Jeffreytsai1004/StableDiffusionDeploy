...
@CALL pip install xformers==0.0.21 --force-reinstall --no-cache-dir
...
@CALL python -B launch.py --xformers --opt-sdp-attention --autolaunch --listen --port 7860 --skip-torch-cuda-test --enable-insecure-extension-access
@CALL PAUSE